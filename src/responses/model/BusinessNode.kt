 ...
 */
data class BusinessNode (
    val typename                           : String,
    val followers_count                    : String,
    val followers_delta_from_last_week     : String,
    val posts_count                        : String,
    val posts_delta_from_last_week         : String,
    val last_week_impressions              : String,
    val week_over_week_impressions         : String,
    val last_week_reach                    : String,
    val week_over_week_reach               : String,
    val last_week_profile_visits           : String,
    val week_over_week_profile_visits      : String,
    val last_week_website_visits           : String,
    val week_over_week_website_visits      : String,
    val last_week_call                     : String,
    val week_over_week_call                : String,
    val last_week_text                     : String,
    val week_over_week_text                : String,
    val last_week_email                    : String,
    val week_over_week_email               : String,
    val last_week_get_direction            : String,
    val week_over_week_get_direction       : String,
    val average_engagement_count           : String,
    val last_week_impressions_day_graph    : String,
    val last_week_reach_day_graph          : String,
    val last_week_profile_visits_day_graph : String,
    val summary_posts                      : String,
    val state                              : String,
    val summary_stories                    : String,
    val followers_unit_state               : String,
    val today_hourly_graph                 : String,
    val gender_graph                       : String,
    val all_followers_age_graph            : String,
    val followers_top_cities_graph         : String,
    val summary_promotions                 : String,
    val top_posts                          : String
){
