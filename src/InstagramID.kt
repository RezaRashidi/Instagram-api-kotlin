...
fun main(){
    ...
    class InstagramID{
         ...
         * @var array|null
         *
         * it dosent have type just write null but in (@var array|null) said its on array of null and i use empty list
         *
         */
        var bitValueTable = arrayOf<String>()
        ...
        fun toCode(id: Int): String{
            ...
            var base2 = self::base10to2(id, false) // No left-padding. Throws if bad.
            if (base2 === '') {
            return '' // Nothing to convert.
        }

            // Left-pad with leading zeroes to make length a multiple of 6 bits.
            var padAmount = (6 - (strlen(base2) % 6));
