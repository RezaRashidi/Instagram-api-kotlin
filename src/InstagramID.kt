...
class InstagramID{
    ...
    static fun toCode(id: String){
        ...
        // static $base2 = self::base10to2(id, false);

        companion object {
            val base2 = self::base10to2(id, false)
     ...
     */
    static fun fromCode(code: String){
