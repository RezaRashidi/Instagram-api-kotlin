...
class Discover(instagram: Instagram) : RequestCollection(instagram) {
	 ...
	 *
	 * @return .instagramAPI.responses.ExploreResponse
	 */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.ReportExploreMediaResponse
	 */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.FBSearchResponse
	 *
	...
	fun search(query:String, latitude:String? = null, longitude:String? = null, array excludeList = [],
		...
		try {
			/** @var responses.FBSearchResponse result */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.SuggestedSearchesResponse
	 */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.RecentSearchesResponse
	 */
