...
class Timeline(instagram:Instagram) : RequestCollection(instagram)
{
        ...
        array externalMetadata = [])
    {
        ...
        foreach (media as key => item) {
            ...
            itemInternalMetadata = InternalMetadata()
     ...
     * @throws .instagramAPI.exception.InstagramException
     *
     * @return .instagramAPI.responses.TimelineFeedResponse
     */
    fun getTimelineFeed(
        maxId = null,
        array options = null)
    {
        ...
        return request.getResponse(Response.TimelineFeedResponse())
    }
     ...
     * @throws .instagramAPI.exception.InstagramException
     *
     * @return .instagramAPI.responses.UserFeedResponse
     */
    fun getUserFeed(
        userId,
        maxId = null)
    {
        ...
        return request.getResponse(Response.UserFeedResponse())
    }
    ...
    fun getArchivedMediaFeed()
    {
        return this.ig.request("feed/only_me_feed/")
            .getResponse(Response.UserFeedResponse())
    }
     ...
     * You can unmark the media again at any time, to make it again.
     *
     * @param string mediaId The media ID in Instagram"s internal format (ie "3482384834_43294").
     *                        "ALBUM", or the raw value of the Item"s "getMediaType()" fun.
     ...
     * @throws .instagramAPI.exception.InstagramException
     *
     * @return .instagramAPI.responses.ArchiveMediaResponse
     */
    fun archiveMedia(
        mediaId,
        onlyMe = true)
    {
        ...
        return this.ig.request("media/{mediaId}/{endpoint}/")
            ...
            .getResponse(Response.ArchiveMediaResponse())
    }
     ...
     * sure to import date_default_timezone_set() with your local timezone if you
        ...
        printProgress = true)
    {
        ...
        do {
            ...
            foreach (myTimeline.getItems() as item) {
                itemDate = date("Y-m-d .a.t H.i.s O", item.getTakenAt())
            ...
            foreach (mediaFiles as mediaId => mediaInfo) {
                ...
                if (printProgress) {
                    echo sprintf("* Downloading ."%s." to ."%s."..n", mediaUrl, filePath)
                }
