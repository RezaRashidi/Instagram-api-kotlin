...
data class User (
    ...
    val is_favorite_for_stories             : Boolean,
    val is_favorite_for_highlights          : Boolean,
    ...
    val coeff_weight                        : String,
    val friendship_status                   : FriendshipStatus,
    val hd_profile_pic_versions             : MutableList<ImageCandidate>,
    val byline                              : String,
    val search_social_context               : String,
    val unseen_count                        : String,
    val mutual_followers_count              : Int,
    val follower_count                      : Int,
    val search_subtitle                     : String,
    ...
    val allow_contacts_sync                 : String,
    val show_feed_biz_conversion_icon       : String,
    val auto_expand_chaining                : String,
    val can_boost_post                      : String,
    val is_profile_action_needed            : Boolean,
    val has_chaining                        : Boolean,
    val has_recommend_accounts              : Boolean,
    val chaining_suggestions                : MutableList<ChainingSuggestion>,
    val include_direct_blacklist_status     : String,
    val can_see_organic_insights            : Boolean,
    val has_placed_orders                   : Boolean,
    val can_convert_to_business             : Boolean,
    val convert_from_pages                  : String,
    val show_business_conversion_icon       : Boolean,
    val show_conversion_edit_entry          : Boolean,
    val show_insights_terms                 : Boolean,
    val can_create_sponsor_tags             : String,
    val hd_profile_pic_url_info             : ImageCandidate,
    val usertag_review_enabled              : String,
    val profile_context_mutual_follow_ids   : MutableList<String>,
    val profile_context_links_with_user_ids : MutableList<Link>,
    val has_biography_translation           : Boolean,
    val total_igtv_videos                   : Int,
    val total_ar_effects                    : Int,
    val can_link_entities_in_bio            : Boolean,
    val biography_with_entities             : BiographyEntities,
    val max_num_linked_entities_in_bio      : Int,
    val business_contact_method             : String,
    val highlight_reshare_disabled          : Boolean,
    val category                            : String,
    val direct_messaging                    : String,
    val page_name                           : String,
    val vfb_page_call_to_action_id          : String,
    ...
    val zip                                 : String,
    val city_id                             : String, // 64-bit number.
    ...
    val birthday                            : String,
    val national_number                     : String, // Really int, but may be >32bit.
    val gender                              : Int,
    val phone_number                        : String,
    val needs_email_confirm                 : String,
    val is_active                           : Boolean,
    val block_at                            : String,
    val aggregate_promote_engagement        : String,
    val fbuid                               : String,
    val page_id                             : String,
    val can_claim_page                      : Boolean,
    val fb_page_call_to_action_ix_app_id    : Int,
    val fb_page_call_to_action_ix_url       : String,
    val can_crosspost_without_fb_token      : Boolean,
    val fb_page_call_to_action_ix_partner   : String,
    ...
    val is_directapp_installed              : Boolean,
    val besties_count                       : Int,
    val can_be_tagged_as_sponsor            : Boolean,
    val can_follow_hashtag                  : Boolean,
    val has_profile_video_feed              : Boolean,
    val is_video_creator                    : Boolean,
    val show_besties_badge                  : Boolean,
    val screenshotted                       : Boolean,
    val nametag                             : Nametag,
    val school                              : String,
    val is_bestie                           : Boolean,
    val live_subscription_status            : String
){
