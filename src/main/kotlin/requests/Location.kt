...
class Location(instagram: Instagram) : RequestCollection(instagram) {
	 ...
	 *
	 * @return .instagramAPI.responses.LocationResponse
	 */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.FBLocationResponse
	 *
	...
	fun findPlaces(query:String, array excludeList = [], rankToken:String? = null) {
		...
		try {
			/** @var responses.FBLocationResponse result */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.RelatedLocationResponse
	 */
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.LocationFeedResponse
	 *
	 ...
	 * @throws .instagramAPI.exception.InstagramException
	 *
	 * @return .instagramAPI.responses.LocationStoryResponse
	 */
	 ...
	 * media items as seen.
	 *
	 * @param responses.LocationStoryResponse locationFeed The location feed
	 *                                                     response object which
	 *                                                     the story media items
	 *                                                     came from. The story
	 *                                                     items MUST belong to it.
	 * @param responses.Model.Item[]          items        Array of one or more
	 *                                                     story media Items.
	 *
	 * @throws  IllegalArgumentException
	 * @throws .instagramAPI.exception.InstagramException
