...
class Media(instagram:Instagram) : RequestCollection(instagram)
{
     ...
     * @throws .InvalidArgumentException
     */
    protected fun _parseLikeParameters(
        $type,
        Request $request,
        $module,
        array $extraData)
