...
class People(instagram:Instagram) : RequestCollection(instagram)
{
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun unfavoriteForStories(
        $userId)
    {
     ...
     */
    protected fun _muteOrUnmuteUserMedia(
        $userId,
        $option,
        $endpoint)
    {
