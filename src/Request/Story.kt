...
class Story : RequestCollection
{
     ...
     */
    public fun uploadCloseFriendsPhoto(
        $photoFilename,
        array $externalMetadata = [])
    {
     ...
     * @see https://help.instagram.com/2183694401643300
     */
    public fun uploadCloseFriendsVideo(
        $videoFilename,
        array $externalMetadata = [])
    {
     ...
     * @see Story::getUserStoryFeed()
     */
    public fun getUserReelMediaFeed(
        $userId)
    {
     ...
     */
    public fun getStoryItemViewers(
        $storyPk,
        $maxId = null)
    {
     ...
     */
    public fun answerStoryQuestion(
        $storyId,
        $questionId,
        $responseText)
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun followStoryCountdown(
        $countdownId)
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun unfollowStoryCountdown(
        $countdownId)
    {
