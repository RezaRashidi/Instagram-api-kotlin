...
class Live(instagram:Instagram) : RequestCollection(instagram)
{
     ...
     */
    public fun getPostLiveViewerList(
        $broadcastId,
        $maxId = null)
    {
     ...
     */
    public fun getHeartbeatAndViewerCount(
        $broadcastId)
    {
     ...
     */
    public fun getJoinRequestCounts(
        $broadcastId,
        $lastTotalCount = 0,
        $lastSeenTs = 0,
        $lastFetchTs = 0)
     ...
     * @return .InstagramAPI.Response.BroadcastQuestionsResponse
     */
    public fun getLiveBroadcastQuestions(
        $broadcastId)
    {
        return this.ig.request("live/{$broadcastId}/questions/")
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun resumeBroadcastAfterContentMatch(
        $broadcastId)
    {
