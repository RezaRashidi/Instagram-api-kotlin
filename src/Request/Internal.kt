...
class Internal (instagram:Instagram) : RequestCollection(instagram)
{
     ...
     * @return .InstagramAPI.Response.ConfigureResponse
     */
    public fun configureSinglePhoto(
        $targetFeed,
        InternalMetadata $internalMetadata,
        array $externalMetadata = [])
    {
     ...
     * @throws .InstagramAPI.Exception.UploadFailedException
     */
    public fun uploadVideoThumbnail(
        $targetFeed,
        InternalMetadata $internalMetadata,
        array $externalMetadata = [])
    {
     ...
     */
    protected fun _requestVideoUploadURL(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return .InstagramAPI.Response.ConfigureResponse
     */
    public fun configureSingleVideo(
        $targetFeed,
        InternalMetadata $internalMetadata,
        array $externalMetadata = [])
    {
     ...
     * @return .InstagramAPI.Response.ConfigureResponse
     */
    public fun configureTimelineAlbum(
        array $media,
        InternalMetadata $internalMetadata,
        array $externalMetadata = [])
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun logResurrectAttribution()
    {
     ...
     */
    public fun bootstrapMsisdnHeader(
        $usage = "ig_select_app")
    {
     ...
     */
    protected fun _saveZeroRatingToken(
     ...
     */
    public fun fetchZeroRatingToken(
     ...
     */
    protected fun _uploadResumableMedia(
     ...
     */
    protected fun _uploadPhotoInOnePiece(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    protected fun _uploadResumablePhoto(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return bool
     */
    protected fun _useResumablePhotoUploader(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
        switch ($targetFeed) {
     ...
     */
    protected fun _uploadVideoChunks(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    protected fun _uploadSegmentedVideo(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
        $videoDetails = $internalMetadata.getVideoDetails()
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    protected fun _uploadResumableVideo(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return bool
     */
    protected fun _useSegmentedVideoUploader(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
     ...
     * @return bool
     */
    protected fun _useResumableVideoUploader(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
        switch ($targetFeed) {
     ...
     * @return array
     */
    protected fun _getPhotoUploadParams(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
        // Common params.
     ...
     * @return array
     */
    protected fun _getVideoUploadParams(
        $targetFeed,
        InternalMetadata $internalMetadata)
    {
        $videoDetails = $internalMetadata.getVideoDetails()
     ...
     * @return VideoDetails[]
     */
    protected fun _splitVideoIntoSegments(
        $targetFeed,
     ...
     * @return int
     */
    protected fun _getTargetSegmentDuration(
        $targetFeed)
    {
        switch ($targetFeed) {
            case Constants::FEED_TIMELINE:
