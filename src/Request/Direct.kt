...
class Direct(instagram:Instagram) : RequestCollection(instagram)
{
     ...
     */
    public fun approvePendingThreads(
        array $threads)
    {
        if (!count($threads)) {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun declinePendingThreads(
        array $threads)
    {
        if (!count($threads)) {
     ...
     */
    public fun getRankedRecipients(
        $mode,
        $showThreads,
        $query = null)
    {
     ...
     */
    public fun getThreadByParticipants(
        array $users)
    {
        if (!count($users)) {
     ...
     */
    public fun sendDisappearingPhoto(
        array $recipients,
        $photoFilename,
     ...
     */
    public fun sendDisappearingVideo(
        array $recipients,
        $videoFilename,
        array $externalMetadata = [])
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun markVisualItemsSeen(
        $threadId,
        $threadItemIds)
    {
     ...
     * @return .InstagramAPI.Response.GenericResponse
     */
    public fun markVisualItemsReplayed(
        $threadId,
        $threadItemIds)
    {
        if (!is_array($threadItemIds)) {
     ...
     * @return array
     */
    protected fun _prepareRecipients(
        array $recipients,
        $useQuotes)
    {
        $result = []
     ...
     * @return .InstagramAPI.Response.DirectSendItemsResponse
     */
    protected fun _sendDirectItems(
        $type,
        array $recipients,
        array $options = [])
    {
