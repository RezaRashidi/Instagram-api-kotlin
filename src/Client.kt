...
class Client
{
     ...
     */
    protected fun _buildGuzzleOptions(
        array $guzzleOptions = [])
    {
        $criticalOptions = [
     ...
     */
    public static fun api_body_decode(
        $json,
        $assoc = true)
    {
